document.addEventListener("DOMContentLoaded", () => {
    ...
    function checkBoard() {
        for (let y = 0; y < winningArrays.length; y++) {
            const square1 = squares[winningArrays[y][0]]; //0
            const square2 = squares[winningArrays[y][1]]; //1
            const square3 = squares[winningArrays[y][2]]; //2
            const square4 = squares[winningArrays[y][3]]; //3
            ...
            if (
                ...
                result.style.background =
                    "linear-gradient(180deg, #FFE6CE 0%, #ECAA00 100%), linear-gradient(180deg, #FFE6CE 0%, #ECAA00 100%)";
                setTimeout(() => {
                    location.reload();
                }, 4000);
            }
            ...
            if (
                ...
                result.style.background =
                    "linear-gradient(180deg, #FF7F7F 0%, #F12C5B 100%), linear-gradient(180deg, #FF7F7F 0%, #F12C5B 100%)";
                setTimeout(() => {
                    location.reload();
                }, 4000);
            }
